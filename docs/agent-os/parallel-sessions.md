...
- Window 1 is not only an idle coordinator; it may take active integration work such as conflict preflight, cross-cutting cleanup, final verification, release checklist execution, and docs reconciliation.
